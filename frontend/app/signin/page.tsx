              ...
              <input
                ...
                className={`w-full bg-white/20 backdrop-blur-sm border ${
                  validationErrors.user_email
                    ? "border-red-400"
                    : "border-white/30"
                } rounded-xl px-4 py-3 text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-white/50 focus:border-transparent transition-all duration-200`}
                ...
                <input
                  ...
                  className={`w-full bg-white/20 backdrop-blur-sm border ${
                    validationErrors.password
                      ? "border-red-400"
                      : "border-white/30"
                  } rounded-xl px-4 py-3 pr-12 text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-white/50 focus:border-transparent transition-all duration-200`}
                  placeholder="••••••••"
                  required
                />
                <button
