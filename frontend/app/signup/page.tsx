  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (form.user_name.trim().length < 2) {
      setValidationErrors(prev => ({
        ...prev,
        user_name: "Name must be at least 2 characters",
      }));
      return;
    }
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full bg-white/20 backdrop-blur-sm border ${
                  validationErrors.user_name ? "border-red-400" : "border-white/30"
                } rounded-xl px-4 py-3 text-white placeholder-white/50 focus:outline-none`}
              />
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className={`w-full bg-white/20 backdrop-blur-sm border ${
                  validationErrors.user_email ? "border-red-400" : "border-white/30"
                } rounded-xl px-4 py-3 text-white placeholder-white/50 focus:outline-none`}
              />
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  } rounded-xl px-4 py-3 pr-12 text-white placeholder-white/50 focus:outline-none`}
                />
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-white text-purple-600 font-semibold py-3 rounded-xl hover:bg-white/90 transition-all mt-2"
            >
